...
model = tf.keras.models.load_model('C:\Users\lmah8\OneDrive\Desktop\Development\2024GCS\backend\Detection\Initial (1).h5')
model.compile()
...
for file in pathlib.Path('/Users/dominicgartner/Desktop/SUAV dataset/Uncropped dataset').iterdir():
    ...
    img = cv2.imread(f"/Users/dominicgartner/Desktop/SUAV dataset/Uncropped dataset/{basename}")
